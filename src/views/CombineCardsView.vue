...
async function combineCards() {
    ...
    //TODO: generated random card based on the combining cards rarities
        ...
        <div id="page_content_container" class="w-full">
            ...
            <div id="page_content_combining_container" class="bg-myDarkBlue border-4 border-myBlack w-[1500px] h-[90%] m-auto grid grid-cols-4">
                ...
                <div id="card1_container" class="w-full h-full grid m-auto">
                    ...
                    <div v-else-if="isCard1Clicked" class="border-2 border-myBeige bg-myBlack w-[80%] h-[80%] grid m-auto">

                        <ul class="text-myBeige overflow-y-scroll">
                            <li v-for="(card, index) in collection.filter(card => card.numberOfCards > 0)" :key="card" class="hover:bg-myBeige hover:text-myBlack border-b-2 border-myBeige grid grid-cols-[80%_20%]"
                ...
                <div id="card2_container" class="w-full h-full grid m-auto">
                    ...
                    <div v-else-if="isCard2Clicked" class="border-2 border-myBeige bg-myBlack w-[80%] h-[80%] grid m-auto">
                ...
                <div id="card3_container" class="w-full h-full grid m-auto">
                    ...
                    <div v-else-if="isCard3Clicked" class="border-2 border-myBeige bg-myBlack w-[80%] h-[80%] grid m-auto">
